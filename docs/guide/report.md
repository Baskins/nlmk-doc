...
На странице рассылки документов доступы следующие элементы управления и навигации:
...
::: tip Обратите внимание как отправляется сертификат качества: 
 - Каждые 30 минут происходить отправка (при условии что создана поставка и есть сертификат в эл.архиве учетной системы ERP НЛМК)
...
А также проверить наличие письем в папке спам.
