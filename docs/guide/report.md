...
Доступен функционал фильтрации данных по колонкам. Узнать как удобно и эффективно работать с таблицами вы можете прочитать по ссылке [Работа с табличными данными](/guide/dx)
