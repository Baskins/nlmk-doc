...
Таблица и даные в ней мгновенно перестроятся согласно настройкам в данном представлении. 

::: tip Примечание
Обратите внимание, что при смене представления изменяется лишь внешний вид таблицы. Повторно отчет не скачитвается. Ожинадние не требуется.
:::
