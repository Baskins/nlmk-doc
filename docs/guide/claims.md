...
При проставлении галки в чекбоксе «Показать только выбранные» (2) на странице поиска будут отображены только те позиции, которые отмечены галкой в чекбоксе.
...
Для того, чтобы добавить позиции в претензию, необходимо отметить их галкой в чекбоксе (9).
...
Для того, чтобы добавить позиции в претензию, необходимо отметить их галкой в чекбоксе.
